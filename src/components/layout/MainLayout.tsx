        ...
        <div className="container-mobile flex items-center justify-between py-3 px-4">
          ...
          <div className="flex items-center gap-1">
            ...
            >
              ...
              {notificationCount > 0 && (
                <span className="absolute -top-0.5 -right-0.5 min-w-[20px] h-[20px] bg-gradient-to-r from-red-500 to-rose-500 rounded-full text-[10px] text-white flex items-center justify-center font-bold shadow-lg ring-2 ring-background px-1.5">
